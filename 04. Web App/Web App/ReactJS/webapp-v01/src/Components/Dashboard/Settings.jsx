...
function Settings({ language, setLoading }) {
  ...
  useEffect(() => {
    const validate = (values) => {
      ...
      if (!values.mobile) {
        ...
        errors.mobile = "* This is an invalid mobile number!";
      }

      /* Requirements for Employees and Bus Owners */
      if (role !== "passenger") {
        // NIC & Birthday validation
        if (!values.nic || !values.birthDay) {
          errors.nic = "* Both fields are required!";
        } else if (!validateNICAndBirthday(values.nic, values.birthDay)) {
          errors.nic = "* This is a invalid NIC number or a birth day!";
        }

        if (empType !== "None") {
          // NTC Reg. No. Validation
          if (!values.ntc) {
            errors.ntc = "* This field is required!";
          }
    ...
    switch (isValid) {
      ...
      case "email": {
        ...
        SweetOTP({
          ...
          inputLabel:
            "To verify the new email address, please enter the otp received on your new email address.",
          onClick: handleOTP,
          timer: timer,
          origin: "email",
        });
      ...
      case "mobile": {
        ...
        SweetOTP({
          ...
          inputLabel:
            "To verify the new mobile number, please enter the otp received on your new mobile number.",
          onClick: handleOTP,
          timer: timer,
          origin: "emailMobile",
        });
      ...
      case "emailMobile": {
        ...
        SweetOTP({
          title: "Mobile Number/Email Verification",
          inputLabel:
            "To verify the new mobile number/email, please enter the otp received on your new mobile number.",
          onClick: handleOTP,
          timer: timer,
          origin: "emailMobile",
        });
      ...
      case "noChange": {
        console.log("Both email and mobile are same as previous.");
        updateData(formData);
        break;
      }
  ...
  const requestOTP = async (data) => {
    ...
    try {
      ...
      ToastAlert({
        type: "warning",
        title: "Something went wrong!\nPlease try again in few second.",
        onClose: refreshPage,
      });
    } finally {
      setLoading(false); // Disabling spinner
                        ...
                        <Col xs={12} xl={6} className="textField">
                          <FormControl fullWidth required={role === "owner"}>
                            ...
                            <Select
                              ...
                              onChange={handleChange}
                            >
                              <MenuItem value="Peoples' Bank">
                                Peoples' Bank
                              </MenuItem>
                              <MenuItem value="Bank of Ceylon">
                                Bank of Ceylon
                              </MenuItem>
                              <MenuItem value="Sampath Bank">
                                Sampath Bank
                              </MenuItem>
                              <MenuItem value="Commercial Bank PLC">
                                Commercial Bank PLC
                              </MenuItem>
                              <MenuItem value="Seylan Bank PLC">
                                Seylan Bank PLC
                              </MenuItem>
                              <MenuItem value="HNB - Hatton National Bank">
                                HNB - Hatton National Bank
                              </MenuItem>
                              <MenuItem value="NTB - Nations Trust Bank">
                                NTB - Nations Trust Bank
                              </MenuItem>
                              <MenuItem value="NDB - National Development Bank">
                                NDB - National Development Bank
                              </MenuItem>
                              <MenuItem value="NSB - National Saving Bank">
                                NSB - National Saving Bank
                              </MenuItem>
                            </Select>
                          </FormControl>
                        </Col>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            {isClicked ? (
              ...
              >
                ...
                {role === "owner" ? (
                  <AndroidSwitch
                    leftLabel="Work as an employee"
                    checked={empType !== "None"}
