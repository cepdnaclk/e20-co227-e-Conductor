...
export default function FormDialog({
  ...
  return (
    <React.Fragment>
      ...
      >
        <DialogTitle fontFamily={"Open Sans"} fontWeight={"Bold"}>
          {title}
        </DialogTitle>
        ...
        <DialogContent>
          ...
          <Grid container spacing={2} mt={"0px"}>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                error={InsError}
                helperText={
                  InsError ? "The insurance card has already expired." : null
                }
              />
            </Grid>
          ...
          <FormControlLabel
            ...
            label="I confirm that all the data provided is true information."
          />
        </DialogContent>
