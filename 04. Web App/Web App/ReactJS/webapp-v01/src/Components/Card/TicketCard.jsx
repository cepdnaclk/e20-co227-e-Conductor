...
export default function TicketCard({ data, handleCancel }) {
  ...
  return (
    ...
    >
      <Box
        bgcolor={tracking ? "#00cc66" : "#ff9900"}
        width={"100%"}
        height={"40px"}
        display={"flex"}
        padding="0 10px"
      ...
      >
        <Grid item width={"165px"}>
          <Box display={"flex"} flexDirection={"column"}>
            <Texts variant="body2" fontSize="12px">
              Origin
            </Texts>
      ...
      <Box padding={"0 10px"}>
        <Texts variant="caption" fontColor="textSecondary">
          {data.regNo} | {data.org} | {data.service} | {data.route}
        </Texts>
      </Box>
      ...
      >
        ...
        <Texts variant="body2">
          Adult: {data.full} | Child: {data.half}{" "}
        </Texts>
      </Box>
      ...
      {tracking ? (
        ...
        >
          <InfoOutlinedIcon
            sx={{ fontSize: "15px", color: "#00cc00", mr: "5px" }}
          />
          <Texts variant="caption" fontColor="#00cc00">
            {" "}
        ...
        >
          <InfoOutlinedIcon
            sx={{ fontSize: "15px", color: "#ff9900", mr: "5px" }}
          />
          <Texts variant="caption" fontColor="#ff9900">
            {" "}
