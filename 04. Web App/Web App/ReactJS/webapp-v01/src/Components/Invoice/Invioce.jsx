  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography variant="h2" fontFamily="Open Sans" fontWeight={700}>
          {" "}
          INVOICE{" "}
        </Typography>
      </Grid>
      ...
      <Divider
        sx={{ border: "none", borderTop: "3px solid black", margin: "5px 0" }}
      />
      ...
      >
        ...
        >
          <Grid>
            <Typography fontFamily="Open Sans" fontWeight="bold" fontSize={19}>
              Invoice To:
            </Typography>
            <Typography fontFamily="Open Sans" fontWeight="bold" fontSize={20}>
              {data.customerName}
            </Typography>
            <Typography
              fontFamily="Open Sans"
            ...
            <Typography
              ...
              fontSize={13}
            >
              Issued On: {data.issuedDate} {data.issuedTime}
            </Typography>
          </Grid>

          <Grid>
            <Typography fontFamily="Open Sans" fontWeight="bold" fontSize={16}>
              e-Conductor&nbsp;(PVT)&nbsp;LTD.
            </Typography>
            <Typography
              fontFamily="Open Sans"
        ...
        <Grid>
          ...
          >
            <Grid container spacing={1}>
              ...
              <Grid item xs={7}>
                <Item>
                  {data.from?.split(",")[0]} to {data.to?.split(",")[0]}
                </Item>
              </Grid>
            ...
            >
              ...
              <Grid item xs={7}>
                <Item>
                  LKR&nbsp;
                  {(
                    parseFloat(data.price) * parseInt(data.full) +
                    0.5 * parseFloat(data.price) * parseInt(data.half)
                  ).toFixed(2)}
                </Item>
              </Grid>
            </Grid>
          ...
          <Box sx={{ display: "flex", mb: "20px", pr: "10px", gap: "35px" }}>
            ...
            <Grid item xs={10}>
              <Item sx={{ flexGrow: 1, textAlign: "left", pl: "15px" }}>
                {data.seatNos}
              </Item>
            </Grid>
          </Box>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell
                  ...
                  sx={{ fontFamily: "Open Sans", fontSize: "14px" }}
                >
                  {(parseFloat(data.price) * parseInt(data.full)).toFixed(2)}
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell
                ...
                <TableCell
                  ...
                  sx={{ fontFamily: "Open Sans", fontSize: "14px" }}
                >
                  {(0.5 * parseFloat(data.price) * parseInt(data.half)).toFixed(
                    2
                  )}
                </TableCell>
              </TableRow>
