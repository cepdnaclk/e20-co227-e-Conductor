...
export default function SignUp1({
  ...
  const [formData, setFormData] = useState(
    userType === Data.userType ? Data : emptyData
  );
  ...
  const [isEmployee, setIsEmployee] = useState(
    userType === "employee" ||
      (userType === "owner" && formData.empType !== "None")
      ? true
      : false
  );
    ...
    >
      <div className="signup-wrapper">
        ...
        <div className="btn-container">
          ...
          <Button onClick={handleSubmit} disabled={isDisable} variant="light">
            Continue
          </Button>
        </div>
      </div>
