...
import useCurrentGPSLocation from '../Components/SessionData/useCurrentGPSLocation';

export default function Home({ language }) {
  const liveData = useCurrentGPSLocation();
  ...
  return (
    <div>
      ...
      <h4>Lat: {liveData.coordinates.lat}</h4>
      <h4>Lng: {liveData.coordinates.lng}</h4>
